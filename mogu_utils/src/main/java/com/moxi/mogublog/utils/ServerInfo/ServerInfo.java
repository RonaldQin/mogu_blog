...
public class ServerInfo {
    ...
    private Cpu cpu = new Cpu(); // CPU相关信息
    private Mem mem = new Mem(); // 内存相关信息
    private Jvm jvm = new Jvm(); // JVM相关信息
    private Sys sys = new Sys(); // 服务器相关信息
    private List<SysFile> sysFiles = new LinkedList<>(); // 磁盘相关信息
